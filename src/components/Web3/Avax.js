...
var aWeb3 = new Web3(web3Provider);
...
const cb_contract = new aWeb3.eth.Contract(cb_abi, cb_add);
...
export const getWavax = async () => {
  ...
  const avaxAbi = [
   ...
   const avaxContract = new aWeb3.eth.Contract(avaxAbi, avaxAdd);
...
export const getAvax = async () => {
  ...
  return aWeb3.eth.getBalance(selectedAccount);
